...
class GetNewFactHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        ...
        speech = data[prompts.GET_FACT_MESSAGE].format(random_fact) + random.choice(data[prompts.STOP_MESSAGE])
        
        handler_input.response_builder.speak(speech).set_card(
            SimpleCard(data[prompts.SKILL_NAME], random_fact))
        return (
            handler_input.response_builder
                .ask("Want me to suggest another hobby? Just say give me another hobby.")
                .response
                )
